        ...
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="images/vision.webp" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>Our Vision</h4>
                            <p class="text-black-50 mb-0">A world where every train traveler can relish hygienic, delicious, and customizable meals, enhancing their travel experience.</p>
                        </div>
                    </div>
                </div>
                <!-- Project One Row-->
                        ...
                        <div class="bg-blue text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    ...
                                    <p class="mb-0 text-white-50">Born out of a desire to redefine train travel, Map Food was founded with the belief that every journey should be accompanied by delectable and wholesome meals. We embarked on this gastronomic journey with the sole purpose of making your train trips healthier, more convenient, and absolutely enjoyable.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-blue text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    ...
                                    <p class="mb-0 text-white-50">We've partnered with the finest restaurants, catering services, and even passionate homemade food vendors located around major train stations. Through our user-friendly website and app, you can explore a diverse menu curated to cater to all palates and preferences. From diet-conscious options to dishes for specific health needs, we've got you covered.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-blue text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    ...
                                    <p class="mb-0 text-white-50">Starting with the bustling Dhaka to Chittagong route, we've carefully chosen stations where our culinary offerings will add value to your journey. Whether you're a student, a professional, or simply someone exploring the world, Map Food promises to be your go-to food provider on the go.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-blue text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-right">
                                    ...
                                    <p class="mb-0 text-white-50">Our dedicated team of founders and collaborators, who are passionate about quality, hygiene, and customer satisfaction, ensures that every meal you order through Map Food meets the highest standards. We strive to enhance your travel experience by providing prompt deliveries and a range of options that cater to your health and taste preferences.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-blue text-center h-100 project">
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    ...
                                    <p class="mb-0 text-white-50">While we're currently focused on specific routes and stations, we're determined to expand our reach and bring the Map Food experience to travelers across the nation. As we grow, our commitment to offering convenient, nutritious, and hygienic meals will remain unwavering.</p>
                                </div>
                            </div>
                        </div>
                    </div>
