...
<html lang="en">
    ...
    <body id="page-top">
                            ...
                            <div class="booking-form">
                                <form action="" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-btn">
                                                <input type="submit" value="Normal" class="submit-btn" name="normal">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-btn">
                                                <input type="submit" value="Rail" class="submit-btn" name="rail">
                                            </div>
                                        </div>
                                    </div>
                                </form>
        ...
        <footer class="footer bg-black small text-center text-white-50">
            <div class="container px-4 px-lg-5">Copyright &copy; MapFood 2023</div>
        </footer>
        <!-- Bootstrap core JS-->
