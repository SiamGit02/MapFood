							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <option value="Dhaka Airport Station" name="das">Dhaka Airport Station</option>
                            <option value="Tongi" name="tongi">Tongi</option>
                            <option value="Norshingdi" name="nsd">Norshingdi</option>
                            <option value="Ashuganj" name="ashuganj">Ashuganj</option>
                            <option value="Akhaura" name="nsd">Akhaura</option>
